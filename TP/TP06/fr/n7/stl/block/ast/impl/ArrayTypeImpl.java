...
public class ArrayTypeImpl implements Type {
	...
	public boolean equalsTo(Type _other) {
		return _other instanceof ArrayTypeImpl && this.element.equalsTo(((ArrayTypeImpl) _other).element);
	}
	...
	public boolean compatibleWith(Type _other) {
		return _other instanceof ArrayTypeImpl && this.element.compatibleWith(((ArrayTypeImpl) _other).element);
	}
