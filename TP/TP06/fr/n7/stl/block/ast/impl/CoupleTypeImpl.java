...
public class CoupleTypeImpl implements CoupleType {
	...
	public boolean equalsTo(Type _other) {
		return _other instanceof CoupleType && this.first.equalsTo(((CoupleTypeImpl) _other).first) && this.second.equalsTo(((CoupleTypeImpl) _other).second);
	}
	...
	public boolean compatibleWith(Type _other) {
		return _other instanceof CoupleType && this.first.compatibleWith(((CoupleTypeImpl) _other).first) && this.second.compatibleWith(((CoupleTypeImpl) _other).second);
	}
